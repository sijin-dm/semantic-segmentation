...
def DualResNet_imagenet():
    ...
    if os.path.isfile(cfg.MODEL.DDRNET23_SLIM_CHECKPOINT):
        logx.msg('=> loading pretrained model {}'.format(cfg.MODEL.DDRNET23_SLIM_CHECKPOINT))
        pretrained_state = torch.load(cfg.MODEL.DDRNET23_SLIM_CHECKPOINT, map_location='cpu') 
