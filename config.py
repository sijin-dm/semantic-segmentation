...
__C.MODEL.HRNET_W18_CHECKPOINT = \
    os.path.join(WEIGHTS_PATH, 'hrnet_w18_small_model_v2.pth')
...
__C.MODEL.OCR_EXTRA_HR18 = AttrDict()
__C.MODEL.OCR_EXTRA_HR18.FINAL_CONV_KERNEL = 1
__C.MODEL.OCR_EXTRA_HR18.STAGE1 = AttrDict()
__C.MODEL.OCR_EXTRA_HR18.STAGE1.NUM_MODULES = 1
__C.MODEL.OCR_EXTRA_HR18.STAGE1.NUM_RANCHES = 1
__C.MODEL.OCR_EXTRA_HR18.STAGE1.BLOCK = 'BOTTLENECK'
__C.MODEL.OCR_EXTRA_HR18.STAGE1.NUM_BLOCKS = [2]
__C.MODEL.OCR_EXTRA_HR18.STAGE1.NUM_CHANNELS = [64]
__C.MODEL.OCR_EXTRA_HR18.STAGE1.FUSE_METHOD = 'SUM'
__C.MODEL.OCR_EXTRA_HR18.STAGE2 = AttrDict()
__C.MODEL.OCR_EXTRA_HR18.STAGE2.NUM_MODULES = 1
__C.MODEL.OCR_EXTRA_HR18.STAGE2.NUM_BRANCHES = 2
__C.MODEL.OCR_EXTRA_HR18.STAGE2.BLOCK = 'BASIC'
__C.MODEL.OCR_EXTRA_HR18.STAGE2.NUM_BLOCKS = [2, 2]
__C.MODEL.OCR_EXTRA_HR18.STAGE2.NUM_CHANNELS = [18, 36]
__C.MODEL.OCR_EXTRA_HR18.STAGE2.FUSE_METHOD = 'SUM'
__C.MODEL.OCR_EXTRA_HR18.STAGE3 = AttrDict()
__C.MODEL.OCR_EXTRA_HR18.STAGE3.NUM_MODULES = 3
__C.MODEL.OCR_EXTRA_HR18.STAGE3.NUM_BRANCHES = 3
__C.MODEL.OCR_EXTRA_HR18.STAGE3.BLOCK = 'BASIC'
__C.MODEL.OCR_EXTRA_HR18.STAGE3.NUM_BLOCKS = [2, 2, 2]
__C.MODEL.OCR_EXTRA_HR18.STAGE3.NUM_CHANNELS = [18, 36, 72]
__C.MODEL.OCR_EXTRA_HR18.STAGE3.FUSE_METHOD = 'SUM'
__C.MODEL.OCR_EXTRA_HR18.STAGE4 = AttrDict()
__C.MODEL.OCR_EXTRA_HR18.STAGE4.NUM_MODULES = 2
__C.MODEL.OCR_EXTRA_HR18.STAGE4.NUM_BRANCHES = 4
__C.MODEL.OCR_EXTRA_HR18.STAGE4.BLOCK = 'BASIC'
__C.MODEL.OCR_EXTRA_HR18.STAGE4.NUM_BLOCKS = [2, 2, 2, 2]
__C.MODEL.OCR_EXTRA_HR18.STAGE4.NUM_CHANNELS = [18, 36, 72, 144]
__C.MODEL.OCR_EXTRA_HR18.STAGE4.FUSE_METHOD = 'SUM'
